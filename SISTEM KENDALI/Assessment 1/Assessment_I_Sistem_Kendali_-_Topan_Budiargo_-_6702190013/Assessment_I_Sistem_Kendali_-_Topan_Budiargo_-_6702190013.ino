...
void readSensor(){
  ...
  for(i=0;i<=5;i++){
    ...
    valSensor[i] = digitalRead(sensor[i]);
...
{  
  ...
  valMotorKiri = 255 * 0.03; //duty cycle motor kiri 3%
...
//jika sensor 5 dan 6 mendeteksi gelap, sisanya terang
  ...
  valMotorKanan = 255*0.03; //duty cycle motor kanan 3%
  //memanggil fungsi writeMotor()
  writeMotor();
  }
